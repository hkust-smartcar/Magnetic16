			...
			m_filter{	pKalmanFilter(pResource::configTable.kAngleKq, pResource::configTable.kAngleKr, 0, 0.5f),
				...
				void pSmartCar::onReceive(const std::vector<Byte>& bytes)
				{
					...
					case '4'://speed
						...
						pResource::m_instance->m_grapher.addWatchedVar(&pResource::m_instance->m_pidOutputVal[Type::Angle], "angle_pid");
						pResource::m_instance->m_grapher.addWatchedVar(&pResource::m_instance->m_idealSpeedOffset, "Speed_pid_smoothed");
						pResource::m_instance->m_grapher.addWatchedVar(&pResource::m_instance->m_idealAngleOffset, "angleOffset");
//						pResource::m_instance->m_grapher.addWatchedVar(&pResource::m_instance->m_smoothIncrement[IncrementType::SpeedIncrement], "speed_increment");
						break;
